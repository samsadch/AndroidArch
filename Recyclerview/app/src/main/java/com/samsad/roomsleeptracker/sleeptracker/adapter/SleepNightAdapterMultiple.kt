...
class SleepNightAdapterMultiple : RecyclerView.Adapter<SleepNightAdapterMultiple.ViewHolder>() {
    ...
    class ViewHolder private constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val sleepQuality: TextView = itemView.findViewById(R.id.sleep_quality_text)
        private val sleepLength: TextView = itemView.findViewById(R.id.sleep_length_text)
